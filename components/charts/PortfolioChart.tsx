...
const THEMES = {
  dark: {
    ...
    accent: '#8AFD81',
    invested: '#64748b',
    investedGlow: '#64748b20',
    bollingerUpper: '#475569',
    bollingerLower: '#475569',
    bollingerFill: '#47556920',
    profit: '#8AFD81',
    loss: '#64748b',
    grid: '#334155',
    gridLight: '#475569',
  ...
  light: {
    ...
    accent: '#8AFD81',
    invested: '#94a3b8',
    investedGlow: '#94a3b820',
    bollingerUpper: '#cbd5e1',
    bollingerLower: '#cbd5e1',
    bollingerFill: '#cbd5e120',
    profit: '#8AFD81',
    loss: '#94a3b8',
    grid: '#e2e8f0',
    gridLight: '#cbd5e1',
